...
$stmt = $conn->prepare("SELECT * FROM products WHERE product_category = 'Coffee' AND is_deleted = FALSE");
...
$products = $stmt->get_result();
          ...
          $stmt1 = $conn->prepare("SELECT COUNT(*) AS total_records FROM products WHERE product_category = 'Coffee'");
          $stmt1->execute();
          ...
          $total_no_of_pages = ceil($total_records/$total_records_per_page);
           ...
           $stmt2 = $conn->prepare("SELECT * FROM products WHERE product_category = 'coffee' LIMIT $offset,$total_records_per_page");
          $stmt2->execute();
